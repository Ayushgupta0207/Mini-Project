...
public class ShowMumbaiBankDetailsUser extends HttpServlet {
...
//             out.print(" <a href = 'javascript:void(0);' class = 'hide-btn' onclick='myFunction()'><i class = 'fa fa-close></i></a>");
           ...
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getbankname()+" , " + e.getlocation() +"  , " +"Mumbai,Maharashtra 230562" +"</p>");
