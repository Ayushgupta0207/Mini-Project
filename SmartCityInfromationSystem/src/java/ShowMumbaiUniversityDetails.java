...
public class ShowMumbaiUniversityDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
         List<AddMumbaiUniversityDetails> list = SelectMumbaiUniversityDetails.getAllDetails();
          out.print("<head>");
...
out.print("<h2>SMART CITY INFORMATION SYSTEM</h2>");
       ...
       out.print("</nav>");
           ...
           for(AddMumbaiUniversityDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getUniversityname()+" , " + e.getlocation() +"  , "+"Mumbai,Maharashtra, 230532" + " <a href='DeleteMumbaiUniversityDetails?UniversityId="+e.getUniversityId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+"</p>");
