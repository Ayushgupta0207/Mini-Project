...
public class ShowDelhiHotelDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddDelhiHotelDetails> list = SelectDelhiHotelDetails.getAllDetails();
          out.print("<head>");
...
out.print("<h2>SMART CITY INFORMATION SYSTEM</h2>");
        ...
        out.print("<nav>");
            out.print("<ul id = 'menu'>");
                out.print("<li><a href='admin-home'>Home</a></li>");
...
//               
           ...
           for(AddDelhiHotelDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getHotelname()+" , " + e.getlocation() +" , " + "Delhi, 110007" + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteDelhiHotelDetails?HotelId="+e.getHotelId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
