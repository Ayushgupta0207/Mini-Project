...
public class ShowMumbaiPlaceDetailsUser extends HttpServlet {
...
out.print("<h2>SMART CITY INFORMATION SYSTEM</h2>");
       // out.print("</div>");
        out.print("<nav>");
          ...
          out.print(" </li>");
            out.print(" <li class = 'allcities'><a href='allcities_user'>All Cities</a>");
            out.print(" </li>");
...
//               
           ...
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getPlacename()+" , " + e.getlocation() +" , " + "Mumbai,Maharashtra,230532" +  "</p>");
