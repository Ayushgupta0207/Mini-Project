...
public class ShowDelhiPlaceDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddDelhiPlaceDetails> list = SelectDelhiPlaceDetails.getAllDetails();
          out.print("<head>");
...
out.print("<h2>SMART CITY INFORMATION SYSTEM</h2>");
        ...
        out.print("<nav>");
            out.print("<ul id = 'menu'>");
                out.print("<li><a href='admin-home.htl'>Home</a></li>");
...
//               out.print("</div>");
//               
            out.print("<h1 style='color:#3e2bb8;font-size:45px;margin:5px;text-align:center;'>Tourist Places</h1>");
           for(AddDelhiPlaceDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getPlacename()+" , " + e.getlocation() +" , " + "Delhi,110007" + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteDelhiPlaceDetails?PlaceId="+e.getPlaceId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
