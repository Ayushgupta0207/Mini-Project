...
public class ShowHyderabadUniversityDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
         List<AddHyderabadUniversityDetails> list = SelectHyderabadUniversityDetails.getAllDetails();
          out.print("<head>");
...
out.print("<h2>SMART CITY INFORMATION SYSTEM</h2>");
       ...
       out.print("</nav>");
           ...
           for(AddHyderabadUniversityDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getUniversityname()+" , " + e.getlocation() +"  , "+"Hyderabad,Andhra Prdesh 500001" + " <a href='DeleteHyderabadUniversityDetails?UniversityId="+e.getUniversityId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+"</p>");
