...
public class ShowMathuraHotelDetailsUser extends HttpServlet {
...
//             out.print(" <a href = 'javascript:void(0);' class = 'hide-btn' onclick='myFunction()'><i class = 'fa fa-close></i></a>");
           ...
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getHotelname()+" , " + e.getlocation() +"  , " +"Mathura,Uttar Prdesh 281406" +"</p>");
