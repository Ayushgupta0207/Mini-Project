...
public class ShowAgraHotelDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddAgraHotelDetails> list = SelectAgraHotelDetails.getAllDetails();
          out.print("<head>");
...
//               
           ...
           for(AddAgraHotelDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getHotelname()+" , " + e.getlocation() +" , " + "Agra,Uttar Prdesh 282006" + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteAgraHotelDetails?HotelId="+e.getHotelId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
