...
public class ShowMathuraPlaceDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddMathuraPlaceDetails> list = SelectMathuraPlaceDetails.getAllDetails();
          out.print("<head>");
...
//               
           ...
           for(AddMathuraPlaceDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getPlacename()+" , " + e.getlocation() +" , " + "Mathura,Uttar Prdesh 281406" + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteMathuraPlaceDetails?PlaceId="+e.getPlaceId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
