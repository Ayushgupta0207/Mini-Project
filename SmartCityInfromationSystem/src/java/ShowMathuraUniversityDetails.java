...
public class ShowMathuraUniversityDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
         List<AddMathuraUniversityDetails> list = SelectMathuraUniversityDetails.getAllDetails();
          out.print("<head>");
...
out.print("<h2>SMART CITY INFORMATION SYSTEM</h2>");
       ...
       out.print("</nav>");
           ...
           for(AddMathuraUniversityDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getbankname()+" , " + e.getlocation() +"  , "+"Mathura,Uttar Prdesh 281406" + " <a href='DeleteMathuraUniversityDetails?UniversityId="+e.getIFSC()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+"</p>");
