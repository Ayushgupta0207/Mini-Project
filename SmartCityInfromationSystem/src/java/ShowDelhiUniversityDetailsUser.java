...
public class ShowDelhiUniversityDetailsUser extends HttpServlet {
...
//           out.print("<a href ='javascript:void(0);' onclick='myFunction()'><i class = 'fa fa-bars' ></i></a>");
          ...
          out.print(" </li>");
            out.print(" <li class = 'allcities'><a href='allcities.html'>All Cities</a>");
            out.print(" </li>");
...
//             out.print(" <a href = 'javascript:void(0);' class = 'hide-btn' onclick='myFunction()'><i class = 'fa fa-close></i></a>");
            ...
            out.print("<h1 style='color:#3e2bb8;font-size:45px;margin:5px;'>University</h1>");
           for(AddDelhiUniversityDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getUniversityname()+" , " + e.getlocation() +"  , " +"Delhi,110007" +"</p>");
