...
public class ShowMumbaiHotelDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddMumbaiHotelDetails> list = SelectMumbaiHotelDetails.getAllDetails();
          out.print("<head>");
...
//               
           ...
           for(AddMumbaiHotelDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getHotelname()+" , " + e.getlocation() +" , " + "Mumbai,Maharashtra 230532" + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteMumbaiHotelDetails?HotelId="+e.getHotelId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
