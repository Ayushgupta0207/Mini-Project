...
public class ShowDelhiBankDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddDelhiBankDetails> list = SelectDelhiBankDetails.getAllDetails();
          out.print("<head>");
...
//               out.print("</div>");
           ...
           for(AddDelhiBankDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getbankname()+" , " + e.getlocation() +" , " + "Delhi, 110007" + " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteDelhiBankDetails?IFSC="+e.getIFSC()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
