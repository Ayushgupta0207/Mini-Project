...
public class ShowMumbaiPlaceDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddMumbaiPlaceDetails> list = SelectMumbaiPlaceDetails.getAllDetails();
          out.print("<head>");
...
//               
           ...
           for(AddMumbaiPlaceDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getPlacename()+" , " + e.getlocation() +" , " + "Mumbai,Maharashtra 230532" + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteMumbaiPlaceDetails?PlaceId="+e.getPlaceId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
