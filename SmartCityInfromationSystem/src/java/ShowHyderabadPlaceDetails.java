...
public class ShowHyderabadPlaceDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddHyderabadPlaceDetails> list = SelectHyderabadPlaceDetails.getAllDetails();
          out.print("<head>");
...
//               
           ...
           for(AddHyderabadPlaceDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getPlacename()+" , " + e.getlocation() +" , " + "Hyderabad,Andhra Prdesh 500001" + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteHyderabadPlaceDetails?PlaceId="+e.getPlaceId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
