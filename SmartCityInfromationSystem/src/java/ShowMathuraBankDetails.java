...
public class ShowMathuraBankDetails extends HttpServlet {
...
out.print("<h2>SMART CITY INFORMATION SYSTEM</h2>");
       ...
       out.print("</nav>");
           ...
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getbankname()+" , " + e.getlocation() +" , " + "Mathura,Uttar Prdesh 281406" + " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteMathuraBankDetails?IFSC="+e.getIFSC()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
