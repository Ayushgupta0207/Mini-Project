...
public class ShowAgraBankDetails extends HttpServlet {
...
out.print("<h2>SMART CITY INFORMATION SYSTEM</h2>");
        ...
        out.print("<nav>");
            out.print("<ul id = 'menu'>");
                ...
                out.print("<script scr='script.js'></script>");
...
//               out.print("</div>");
           ...
           for(AddAgraBankDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getbankname()+" , " + e.getlocation() +" , " + "Agra,Uttar Prdesh 282006" + " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteAgraBankDetails?IFSC="+e.getIFSC()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
