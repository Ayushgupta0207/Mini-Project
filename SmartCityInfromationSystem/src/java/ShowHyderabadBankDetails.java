...
public class ShowHyderabadBankDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddHyderabadBankDetails> list = SelectHyderabadBankDetails.getAllDetails();
          out.print("<head>");
...
out.print("<h2>SMART CITY INFORMATION SYSTEM</h2>");
        ...
        out.print("<nav>");
            out.print("<ul id = 'menu'>");
                ...
                out.print("<li class = 'MyAccount'><a href='myaccount'>My Account</a></li>");
...
//               out.print("</div>");
            ...
            out.print("<h1 style='color:#3e2bb8;font-size:45px;margin:5px;text-align:center;'>Banks</h1>");
           for(AddHyderabadBankDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getbankname()+" , " + e.getlocation() +" , " + "Hyderabad,Andhra Pradesh 500001" + " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteHyderabadBankDetails?IFSC="+e.getIFSC()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
