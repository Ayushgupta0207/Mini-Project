...
public class ShowMumbaiBankDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddMumbaiBankDetails> list = SelectMumbaiBankDetails.getAllDetails();
          out.print("<head>");
...
//               out.print("</div>");
           ...
           for(AddMumbaiBankDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getbankname()+" , " + e.getlocation() +" , " + "Mumbai,Maharasthra 230562" + " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteMumbaiBankDetails?IFSC="+e.getIFSC()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
