...
public class ShowHyderabadHotelDetails extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
           ...
           List<AddHyderabadHotelDetails> list = SelectHyderabadHotelDetails.getAllDetails();
          out.print("<head>");
...
//               
           ...
           for(AddHyderabadHotelDetails e : list ){
           
           out.print("<div class='banks'>");
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getHotelname()+" , " + e.getlocation() +" , " + "Hyderabad,Andhra Prdesh 500001" + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteHyderabadHotelDetails?HotelId="+e.getHotelId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
