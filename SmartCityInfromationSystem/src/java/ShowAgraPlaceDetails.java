...
public class ShowAgraPlaceDetails extends HttpServlet {
...
//               
           ...
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getPlacename()+" , " + e.getlocation() +" , " + "Agra,Uttar Prdesh 282006" + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href='DeleteAgraPlaceDetails?PlaceId="+e.getPlaceId()+"'><i class='fa fa-trash' style='color:white;float:right;'></i></a>"+ "</p>");
