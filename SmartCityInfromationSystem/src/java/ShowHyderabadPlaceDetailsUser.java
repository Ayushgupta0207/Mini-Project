...
public class ShowHyderabadPlaceDetailsUser extends HttpServlet {
...
//               
           ...
           out.print("<p><i class='fa fa-star'></i>&nbsp"+e.getPlacename()+" , " + e.getlocation() +" , " + "Hyderabad,Andhra Prdesh 500001" +  "</p>");
